...
public class UserData extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference.orderByChild("number").equalTo(phoneNumber).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    SharedPreferences.Editor editor = sharedPreferences.edit();
                    editor.putString("userImage", snapshot.child("image").toString()).apply();
                    editor.putString("username", snapshot.child("name").toString()).apply();
