...
import com.chatapp.chatme_doan.adapter.ContactAdapter;
import com.chatapp.chatme_doan.constants.AllConstants;
import com.chatapp.chatme_doan.databinding.FragmentContactBinding;
...
//        getAppContactsLocal();
    ...
    private void getAppContactsLocal() {
        appContacts = new ArrayList<>();
        databaseReference = FirebaseDatabase.getInstance().getReference("Users");
